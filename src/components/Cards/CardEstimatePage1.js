    ...
    <div className="flex-auto">
      ...
      >
        <div className="flex flex-wrap">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="costCenter">
                Cost Center (Project No)
              </label>
              <input
                type="text"
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="warehouse">
                Warehouse
              </label>
              <select
                id="warehouse"
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="estimateDt">
                Estimate Date
              </label>
              <input
                type="date"
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="fileRef">
                File Reference
              </label>
              <input
                type="text"
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="rejectReason">
                Reject Reason
              </label>
              <input
                type="text"
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="esName">
                Client Name
              </label>
              <input
                type="text"
          ...
          <div className="w-full lg:w-12/12 px-4">
            <div className="relative w-full mb-3">
              <label className="block text-gray-700 text-sm mb-2" htmlFor="descr">
                Description
              </label>
              <textarea
                id="descr"
