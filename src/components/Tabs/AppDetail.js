...
// const AppDetails = ({ onInputChange, isModify, data, errors = {} }) => {
//   const [appData, setAppData] = useState({
//     applicationNo: "",
//     description: "",
//     jobName: "",
...
//           <div className="w-full lg:w-6/12 px-4">
//             <div className="relative w-full mb-3">
//               <label className="block text-gray-700 text-sm mb-2">Application No</label>
//               <input
//                 type="text"
//                 name="applicationNo"
//                 value={appData.applicationNo || ""}
//                 onChange={handleChange}
//                 className={`p-2 w-full border border-gray-300 rounded text-sm bg-white focus:outline-none focus:border-[#7c0000] focus:shadow-[0_0_0_2px_rgba(124,0,0,0.1)] transition-all duration-150 ${errors.applicationNo ? "border-red-500" : ""}`}
...
//                 value={appData.description || ""}
//                 onChange={handleChange}
//                 className={`p-2 w-full border border-gray-300 rounded text-sm bg-white focus:outline-none focus:border-[#7c0000] focus:shadow-[0_0_0_2px_rgba(124,0,0,0.1)] transition-all duration-150 ${errors.description ? "border-red-500" : ""}`}
//                 placeholder="Enter Description"
//               />
...
//           <div className="w-full lg:w-6/12 px-4">
//             <div className="relative w-full mb-3">
//               <label className="block text-gray-700 text-sm mb-2">Job Name</label>
//               <input
//                 type="text"
//                 name="jobName"
//                 value={appData.jobName || ""}
...
// const AppDetails = ({ onInputChange, data = {}, errors = {}, isModify }) => {
//   const handleChange = (e) => {
//     const { name, value } = e.target;
...
//               onChange={handleChange}
//               placeholder="e.g. 430.00/ABS/25/xxxx"
//               className={`p-2 w-full border rounded text-sm focus:outline-none focus:border-[#7c0000] focus:shadow-[0_0_0_2px_rgba(124,0,0,0.1)] transition-all ${
//                 errors.applicationNo ? "border-red-500" : "border-gray-300"
//               }`}
//               readOnly={isModify}
//             />
//             {errors.applicationNo && (
//               <p className="text-red-500 text-xs mt-1">{errors.applicationNo}</p>
//             )}
//           </div>
...
//           {/* Area */}
//           <div className="w-full lg:w-6/12 px-4 mb-6">
//             <label className="block text-gray-700 text-sm mb-2">Area</label>
//             <select
//               name="area"
//               value={data.area || ""}
//               onChange={handleChange}
...
//           {/* Cost Center */}
//           <div className="w-full lg:w-6/12 px-4 mb-6">
//             <label className="block text-gray-700 text-sm mb-2">Cost Center</label>
//             <input
//               type="text"
//               name="costCenter"
...
//             <label className="block text-gray-700 text-sm mb-2">Is Loan Application?</label>
...
const AppDetails = ({ onInputChange, isModify, data = {}, errors = {}, handleSearch }) => {
  const [appData, setAppData] = useState({
    applicationId: "",
    description: "",
    jobName: "",
    ...
    <div className="flex-auto px-4 lg:px-10 py-10 pt-2">
      <form onSubmit={(e) => e.preventDefault()}>
        <div className="flex flex-wrap -mx-4">
          {/* Temporary ID with Search */}
          <div className="w-full lg:w-6/12 px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Temporary ID</label>
            <div className="flex">
              <input
                type="text"
                name="applicationId"
            ...
            {errors.applicationId && (
              <p className="text-red-500 text-xs mt-1">{errors.applicationId}</p>
            )}
          </div>
          ...
          {/* Fund Source */}
          <div className="w-full lg:w-6/12 px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Fund Source</label>
            <select
              name="fundSource"
              value={appData.fundSource || ""}
              onChange={handleChange}
          ...
          {/* Representative 1 */}
          <div className="w-full lg:w-6/12 px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Representative 1</label>
            <input
              type="text"
              name="representative1"
              value={appData.representative1 || ""}
          ...
          {/* Consumer Reference */}
          <div className="w-full lg:w-6/12 px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Consumer Reference</label>
            <input
              type="text"
              name="consumerRef"
              value={appData.consumerRef || ""}
          ...
          {/* Nature of Supply */}
          <div className="w-full px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Nature of Supply</label>
          ...
          {/* Is Loan App */}
          <div className="w-full px-4 mb-6">
            <label className="block text-gray-700 text-sm mb-2">Is Loan App</label>
