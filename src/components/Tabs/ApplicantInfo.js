            ...
            <div className="relative w-full mb-3">
              ...
              <div className="flex">
                <input
                  ...
                  value={data.idNo || ""}
                  onChange={handleChange}
                  readOnly={isModify} // Make read-only in modify mode to prevent changing ID
                ...
                <button
                  type="button"
                  onClick={handleSearch}
                  disabled={searchLoading || !!errors.idNo || isModify} // Disable search in modify mode if needed
                  className="bg-[#7c0000] text-white text-sm px-4 rounded ml-2 hover:bg-[#a00000] focus:outline-none focus:ring-2 focus:ring-[#7c0000] focus:ring-opacity-50 disabled:opacity-50"
                >
                  {searchLoading ? "Searching..." : "Search"}
                </button>
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              ...
              <input
                ...
                value={data.lastName || ""}
                onChange={handleChange}
                className={`p-2 w-full border border-gray-300 rounded text-sm bg-white focus:outline-none focus:border-[#7c0000] focus:shadow-[0_0_0_2px_rgba(124,0,0,0.1)] transition-all duration-150 ${errors.lastName ? "border-red-500" : ""}`}
                placeholder="Enter Last Name"
              />
              {errors.lastName && (
                <p className="text-red-500 text-xs mt-1">{errors.lastName}</p>
          ...
          <div className="w-full lg:w-12/12 px-4">
            <div className="relative w-full mb-3">
              ...
              <input
                ...
                value={data.fullName || ""}
                onChange={handleChange}
                className={`p-2 w-full border border-gray-300 rounded text-sm bg-white focus:outline-none focus:border-[#7c0000] focus:shadow-[0_0_0_2px_rgba(124,0,0,0.1)] transition-all duration-150 ${errors.fullName ? "border-red-500" : ""}`}
                placeholder="Enter Full Name"
              />
              {errors.fullName && (
                <p className="text-red-500 text-xs mt-1">{errors.fullName}</p>
