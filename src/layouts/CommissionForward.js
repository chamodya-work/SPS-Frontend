...
import CommissionForward from "views/commission/CommissionForward";
import CommissionDetailsForward from "views/commission/CommissionDetailsForward";

// src/layouts/Commission.js
export default function CommissionForwardLayout() {
  return (
    <>
      <Sidebar />
      <div className="relative md:ml-64 bg-blueGray-100">
        ...
        <div className="px-4 md:px-10 mx-auto w-full -m-24">
          <Switch>
            <Route path="/admin/commission/forward" exact component={CommissionForward} />
            {/* Add new route for details */}
            <Route path="/admin/commission/forward/:id" component={CommissionDetailsForward} />
          </Switch>
          <FooterAdmin />
        </div>
      </div>
