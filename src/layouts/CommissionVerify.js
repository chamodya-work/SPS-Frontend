...
import CommissionVerify from "views/commission/CommissionVerify";
import CommissionDetailsVerify from "views/commission/CommissionDetailsVerify";

// src/layouts/Commission.js
export default function CommissionVerifyLayout() {
  return (
    <>
      <Sidebar />
      <div className="relative md:ml-64 bg-blueGray-100">
        ...
        <div className="px-4 md:px-10 mx-auto w-full -m-24">
          <Switch>
            <Route path="/admin/commission/verify" exact component={CommissionVerify} />
            {/* Add new route for details */}
            <Route path="/admin/commission/verify/:id" component={CommissionDetailsVerify} />
          </Switch>
          <FooterAdmin />
        </div>
      </div>
